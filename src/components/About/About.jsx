                        ...
                        <AboutCard>
                          ...
                          <div className="page-content__block about-card-content _dates-content">
                            <p className="page-content__text text">
                              ...
                              to&nbsp;create a&nbsp;balance card, which
                              is&nbsp;based on&nbsp;the well-known exercise
                              &laquo;Wheel of&nbsp;Life Balance&raquo;.
                              It&nbsp;appeared in&nbsp;the USA at&nbsp;the end
                              of&nbsp;the 70s of&nbsp;the 20th century and soon
                              turned into one of&nbsp;the most popular coaching
                              techniques in&nbsp;the world. The essence
                              of&nbsp;the exercise is&nbsp;to&nbsp;visually
                              depict the basic values of&nbsp;a&nbsp;person
                              in&nbsp;the form of&nbsp;a&nbsp;drawing, where
                              they are represented as&nbsp;the radii of&nbsp;the
                              life circle or&nbsp;wheel spokes.
                            </p>
                            <Link
                              to="/diagnostics"
                              className="page-content__link about-card__link link"
                        ...
                        <AboutCard>
                          ...
                          <div className="page-content__block about-card-content">
                            <p className="page-content__text text">
                              ...
                              approximate&nbsp;&mdash; it&nbsp;depends
                              on&nbsp;the mood of&nbsp;a&nbsp;person and many
                              other factors. To&nbsp;make it&nbsp;more accurate,
                              we&nbsp;offer the user to&nbsp;answer eight simple
                              questions, each of&nbsp;which is&nbsp;devoted
                        ...
                        <AboutCard>
                          ...
                          <div className="page-content__block about-card-content">
                            <p className="page-content__text text">
                              ...
                              problematic. Based on&nbsp;the answers,
                              we&nbsp;form a&nbsp;small encouraging
                              recommendation for further actions in&nbsp;this
