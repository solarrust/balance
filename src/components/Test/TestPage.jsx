      ...
      <div className="page test">
        <div className="test-card _main">
          ...
          <p className="test-text text">
            To&nbsp;create your Balance map, we&nbsp;will ask you eight
            questions about the main areas of&nbsp;your life. Each question has
            parameters by&nbsp;which we&nbsp;determine how satisfied you are
            with this area. Your task is&nbsp;to&nbsp;evaluate the parameters
            on&nbsp;a&nbsp;scale from 1&nbsp;to&nbsp;10. And one more
            thing&nbsp;&mdash; answer as&nbsp;honestly as&nbsp;possible!
          </p>
